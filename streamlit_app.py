...
st.write("This tool helps you estimate your retirement savings and manage your medium- and long-term goals.")
st.write("To get started, please fill out the fields below. You can add any medium- or long-term goals you want to save for, such as a down payment on a house or a wedding. You can specify your goal either by entering the target date for achieving it or by providing your desired monthly contribution; we’ll calculate the monthly contribution required or year you can expect to reach that goal. Once you’ve set your goal, click 'Add to timeline,' and it will appear in the timeline at the bottom of the tool. If you wish to remove a goal, you can delete it from the left-side panel.")
...
rate_of_return = st.number_input("Rate of return or interest rate (%)", min_value=0.0, max_value=100.0, value=5.0)
