...
st.write("To get started, please fill out the fields below. You can add any medium- or long-term goals you want to save for, such as a down payment on a house or a wedding. You can specify your goal either by entering the target date for achieving it or by providing your desired monthly contribution; we’ll calculate the year you can expect to reach that goal. Once you’ve set your goal, click 'Add goal to timeline,' and it will appear in the life timeline at the bottom of the page. If you wish to remove a goal, you can delete it from the left-side panel.")
